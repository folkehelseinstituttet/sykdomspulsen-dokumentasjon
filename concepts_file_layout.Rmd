...
for(i in x) print(i, quote = FALSE)
```
...
https://github.com/folkehelseinstituttet/scskeleton/blob/main/R/weather_export_weather_plots.r

```{r, echo=FALSE}
options(width = 150)
x <- readLines("https://raw.githubusercontent.com/folkehelseinstituttet/scskeleton/main/R/weather_export_weather_plots.r")
for(i in x) print(i, quote = FALSE)
```
