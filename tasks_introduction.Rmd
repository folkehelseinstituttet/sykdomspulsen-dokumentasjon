...
```{r general-tasks, layout="l-body-outset", fig.cap="A general task showing the many options of a task."}
...
```{r file-locations, layout="l-body-outset", fig.cap="A typical file setup for an implementation of Sykdomspulsen Core. `plan_argset_fn` is rarely used, and is therefore shown as blacked out in the most of the tasks."}
